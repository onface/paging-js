...
describe('#createData.js', function() {
    ...
    it('proptypes page type need is number ', function (){
        createData({page: '1', pageCount: 10})
    ...
    it('Error settings: need pageCount or pageSize&dataTotal!', function (){
        var errorMessage = ''
        try {
            createData({page: 1})
        } catch (e) {
        ...
        expect(errorMessage).to.eql('settings: need pageCount or pageSize&dataTotal!')
    })
    it('calculation pageCount', function () {
        var output = createData({
            page: 1,
            dataTotal: 102,
            pageSize: 10
        })
    ...
    it('hasPaging dataTotal 1', function () {
        var output = createData({
            page: 1,
            dataTotal: 1,
            pageSize: 10
    ...
    it('hasPaging pageCount 1', function () {
        ...
        expect(output.hasPaging).to.eql(true)
    })
